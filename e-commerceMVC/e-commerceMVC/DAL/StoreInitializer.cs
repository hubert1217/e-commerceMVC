    ...
    public class StoreInitializer : MigrateDatabaseToLatestVersion<StoreContext, Configuration>
    {
        ...
        public static void SeedStoreData(StoreContext context)
        {
            ...
            var products = new List<Product>
            {
                ...
                new Product() {ProductId = 2,KategoryId = 2, ProductName = "LG 3D", DateAdded= new DateTime(2010,08,08), ProductFileName="2.png",Description="Monitor z funkcją 3D",Price=108,IsBestseller=false},
                new Product() {ProductId = 3,KategoryId = 3, ProductName = "Razer DeathStalker", DateAdded= new DateTime(2011,09,8), ProductFileName="3.png",Description="Klawiatura mechaniczna",Price=300,IsBestseller=true},
                new Product() {ProductId = 4,KategoryId = 4, ProductName = "StellSeries", DateAdded= new DateTime(2012,09,8), ProductFileName="4.png",Description="Myszka dla graczy",Price=20,IsBestseller=false},
                new Product() {ProductId = 5,KategoryId = 1, ProductName = "Toshiba AA120", DateAdded= new DateTime(2010,09,8), ProductFileName="5.png",Description="Intel celeron 3.0, 4GB RAm",Price=4000,IsBestseller=false},
